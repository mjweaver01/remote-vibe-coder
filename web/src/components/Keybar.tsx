    ...
    <>
      ...
      <div className="keybar keybar-mobile" role="toolbar" aria-label="Terminal keys">
        ...
        <div className="gb-diamond">
          <button className="gb-diamond-btn gb-btn-yes"   onClick={() => onSend('1')}  title="Yes (1)"   aria-label="Yes (1)">1</button>
          <button className="gb-diamond-btn gb-btn-no"    onClick={() => onSend('2')}  title="No (2)"    aria-label="No (2)">2</button>
          <div className="gb-diamond-hub" aria-hidden="true" />
          <button className="gb-diamond-btn gb-btn-other" onClick={() => onSend('3')}  title="Other (3)" aria-label="Other (3)">3</button>
          <button className="gb-diamond-btn gb-btn-enter" onClick={() => onSend('\r')} title="Enter"     aria-label="Enter">
        ...
        <div className="gb-secondary">
          <button className="gb-sec-btn" onClick={() => onSend('\x1b')} title="Escape" aria-label="Escape">Esc</button>
          <button className="gb-sec-btn" onClick={() => onSend('\t')}   title="Tab"    aria-label="Tab">Tab</button>
          {voiceSlot}
          <button className="gb-sec-btn" onClick={onSummonKeyboard} title="Open soft keyboard" aria-label="Open soft keyboard">
            <Keyboard size={14} aria-hidden="true" />
          </button>
          <button
